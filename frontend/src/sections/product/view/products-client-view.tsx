...
import { ProductSort } from '../components/client/product-sort';
import { CartIcon } from '../components/client/product-cart-widget';
import { ProductFilters } from '../components/client/product-filters';

import type { FiltersProps } from '../components/client/product-filters';
...
export default function ProductClientView() {
    ...
    return (
      <>
        {cartItems.length != 0 && <CartIcon totalItems={cartItems.length} />}
