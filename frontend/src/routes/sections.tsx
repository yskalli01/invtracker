...
// Supplier section 
export const SupplierPage = lazy(() => import('src/pages/supplier/supplier'));

// User section
export const UserPage = lazy(() => import('src/pages/user/user'));

// Product section
export const ProductsPage = lazy(() => import('src/pages/product/product'));

// Order section
export const OrdersPage = lazy(() => import('src/pages/order/order'));
